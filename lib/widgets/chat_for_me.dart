...
class ChatForMe extends StatefulWidget {
  const ChatForMe({
    super.key,
  ...
  @override
  State<ChatForMe> createState() => _ChatForMeState();
}

class _ChatForMeState extends State<ChatForMe> {
    ...
    return GestureDetector(
      onLongPress: () {
        showDialog(
          ...
          builder:
              (context) => AlertDialog(
                title: Center(child: Text('delete a message')),
                content: Padding(
                  padding: const EdgeInsets.only(left: 8),
                  child: Text('do you want to delete a message?'),
                ),
                actions: [
                  Row(
                    ...
                    children: [
                      TextButton(
                        onPressed: () async {
                          ...
                          if (widget.message.documentId != null) {
        ...
        child: Column(
          ...
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _isVoiceMessage() ? VoiceMessage() : _buildTextMessage(),
